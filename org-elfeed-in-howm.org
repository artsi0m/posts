...
[[https://github.com/skeeto/elfeed][Elfeed]]  was connected to [[https://kaorahi.github.io/howm/][howm]] via [[https://github.com/remyhonig/elfeed-org][org-elfeed]].

I don't need it in my config anymore, because I switched to gnus and now
...
** BUGS
Wouldn't work without execution of =M-x elfeed= and =M-x elfeed-update= in the first place.
